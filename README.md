...
| **VerSe '19 CT** | Run 3 (`ch=42`, 14.5M) | 45 | 0.8877 | 0.8254 | 8.57 mm | ✅ Completed |
...
| **Run 3 (V19)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '19 | Vertebrae (Combined) | **0.8877** (Epoch 45) | **8.57 mm** (3D-HD95) |
