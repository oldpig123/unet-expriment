...
| **VerSe '19 CT** | Run 2 (`ch=42`, 14.5M) | 30/50 | 0.8951 | 0.8343 | 7.57 mm | 🔄 Training |
...
| **Run 2 (V19)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '19 | Vertebrae (Combined) | **0.8951** (Epoch 30, 🔄 training) | **7.57 mm** (3D-HD95) |
