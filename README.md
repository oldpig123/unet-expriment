...
| **VerSe '19 CT** | Run 3 (`ch=42`, 14.5M) | 47/60 (Best: 45) | 0.8877 | 0.8254 | 8.57 mm | 🔄 Training |
| **VerSe '20 CT** | Run 3 (`ch=42`, 14.5M) | 36/60 (Best: 15) | 0.9167 | 0.8626 | 4.14 mm | 🔄 Training |
...
| **Run 3 (V19)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '19 | Vertebrae (Combined) | **0.8877** (Epoch 45, 🔄 training) | **8.57 mm** (3D-HD95) |
