...
| **VerSe '19 CT** | Run 2 (`ch=42`, 14.5M) | 35/50 | 0.8951 | 0.8204 | 6.44 mm | 🔄 Training |
...
| **Run 2 (V19)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '19 | Vertebrae (Combined) | **0.8951** (Epoch 35, 🔄 training) | **6.44 mm** (3D-HD95) |
