...
| **VerSe '19 CT** | Run 3 (`ch=42`, 14.5M) | 6 | 0.8845 | 0.8198 | 9.09 mm | ✅ Completed |
| **VerSe '20 CT** | Run 3 (`ch=42`, 14.5M) | 29/60 (Best: 15) | 0.9167 | 0.8626 | 4.14 mm | 🔄 Training |
...
| **Run 3 (V19)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '19 | Vertebrae (Combined) | **0.8845** (Epoch 6) | **9.09 mm** (3D-HD95) |
