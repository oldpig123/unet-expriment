...
#### Run 2 — `base_channels=42` (14.5M parameters), 3D patient-level HD95 in mm (Aborted/Faulty Preprocessing)
...
| **VerSe '20 CT** | Run 2 (`ch=42`, 14.5M) | 24 | 0.9101 | 0.8582 | 6.92 mm | 🛑 Aborted |

#### Run 3 — `base_channels=42` (14.5M parameters), 3D patient-level HD95 in mm (Hierarchical Training & Preprocessing Fix)

| Dataset | Config | Epochs | Best Val Dice | Val IoU | Best 3D-HD95 | Status |
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **Mendeley Lumbar MRI** | Run 3 (`ch=42`, 14.5M) | 34 | 0.9633 | 0.9299 | 0.18 mm | ✅ Completed |
| **VerSe '19 CT** | Run 3 (`ch=42`, 14.5M) | 44/60 (Best: 41) | 0.8872 | 0.8252 | 10.21 mm | 🔄 Training |
| **VerSe '20 CT** | Run 3 (`ch=42`, 14.5M) | 34/60 (Best: 15) | 0.9167 | 0.8626 | 4.14 mm | 🔄 Training |
...
#### Visual Verification Panels for Completed & Active Runs:

*   **Mendeley Lumbar Spine MRI (Completed — Best Model at Epoch 34)**: Val Dice: `0.9633` | Val IoU: `0.9299` | Val 3D-HD95: `0.18 mm`
    ![Lumbar MRI Best Model Verification Panel](./verification_plot_lumbar_mri_best.png)
...
| **Run 3** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | **0.9462** | **0.9804** | **0.9633** (Epoch 34) | **0.18 mm** (3D-HD95) |
...
| **Run 3 (V19)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '19 | Vertebrae (Combined) | **0.8872** (Epoch 41, 🔄 training) | **10.21 mm** (3D-HD95) |
| **Run 3 (V20)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '20 | Vertebrae (Combined) | **0.9167** (Epoch 15, 🔄 training) | **4.14 mm** (3D-HD95) |
...
| **Metric Units (95% HD)**| Millimeters (mm) | Pixels (converted to mm post-hoc) | Logged directly on 512x512 grids. Spacings: MRI approximately 0.586 mm/px, CT = 1.0 mm/px. |
