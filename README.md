...
| **VerSe '19 CT** | Run 2 (`ch=42`, 14.5M) | 25/50 | 0.8876 | 0.8151 | 7.57 mm | 🔄 Training |
...
| **Run 2 (V19)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '19 | Vertebrae (Combined) | **0.8876** (Epoch 25, 🔄 training) | **7.57 mm** (3D-HD95) |
