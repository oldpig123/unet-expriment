...
| **VerSe '19 CT** | Run 2 (`ch=42`, 14.5M) | 5/50 | 0.8785 | 0.8037 | 11.96 mm | 🔄 Training |
| **VerSe '20 CT** | Run 2 (`ch=42`, 14.5M) | 2/50 | 0.8990 | 0.8363 | 8.48 mm | 🔄 Training |
...
| **Run 2 (V19)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '19 | Vertebrae (Combined) | **0.8785** (Epoch 5, 🔄 training) | **11.96 mm** (3D-HD95) |
| **Run 2 (V20)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '20 | Vertebrae (Combined) | **0.8990** (Epoch 2, 🔄 training) | **8.48 mm** (3D-HD95) |
