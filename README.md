...
| **VerSe '20 CT** | Run 2 (`ch=42`, 14.5M) | 6/50 | 0.9105 | 0.8534 | 4.73 mm | 🔄 Training |
...
| **Run 2 (V20)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '20 | Vertebrae (Combined) | **0.9105** (Epoch 6, 🔄 training) | **4.73 mm** (3D-HD95) |
