...
| **VerSe '19 CT** | Run 2 (`ch=42`, 14.5M) | 4/50 | 0.8785 | 0.8098 | 14.07 mm | 🔄 Training |
...
| **Run 2 (V19)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '19 | Vertebrae (Combined) | **0.8785** (Epoch 4, 🔄 training) | **14.07 mm** (3D-HD95) |
