...
| **VerSe '19 CT** | Run 3 (`ch=42`, 14.5M) | 23/60 (Best: 6) | 0.8845 | 0.8198 | 9.09 mm | 🔄 Training |
| **VerSe '20 CT** | Run 3 (`ch=42`, 14.5M) | 15/60 (Best: 14) | 0.9150 | 0.8601 | 4.41 mm | 🔄 Training |
...
| **Run 3 (V20)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '20 | Vertebrae (Combined) | **0.9150** (Epoch 14, 🔄 training) | **4.41 mm** (3D-HD95) |
