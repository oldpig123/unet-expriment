...
| **VerSe '19 CT** | Run 2 (`ch=42`, 14.5M) | 6/50 | 0.8785 | 0.7912 | 8.78 mm | 🔄 Training |
...
| **Run 2 (V19)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '19 | Vertebrae (Combined) | **0.8785** (Epoch 6, 🔄 training) | **8.78 mm** (3D-HD95) |
