...
| **VerSe '19 CT** | Run 3 (`ch=42`, 14.5M) | 66/60 (Best: 65) | 0.8884 | 0.8266 | 15.06 mm | 🔄 Training |
| **VerSe '20 CT** | Run 3 (`ch=42`, 14.5M) | 47/60 (Best: 40) | 0.9168 | 0.8625 | 5.91 mm | 🔄 Training |
...
| **Run 3 (V19)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '19 | Vertebrae (Combined) | **0.8884** (Epoch 65, 🔄 training) | **15.06 mm** (3D-HD95) |
| **Run 3 (V20)** (`ch=42`, 14.5M) | Ours (U-ResNet + SAAM) | VerSe '20 | Vertebrae (Combined) | **0.9168** (Epoch 40, 🔄 training) | **5.91 mm** (3D-HD95) |
